...
- `data/typhoon.json`：当前影响海南的热带扰动、潜在热带气旋、热带低压和已编号台风状态，并记录风险等级、主要灾害与多条官方来源。
...
采用“影响优先、命名分开”的判定：只要官方气象部门明确指出热带扰动、低压区、潜在热带气旋、热带低压或已编号台风正在或预计影响海南，就进入天气关注区；是否已经获得台风编号另行标注。这样不会因为系统尚未命名就显示“无影响”。

天气状态分为：

- `none`：未发现影响海南的热带天气系统；
- `watch`：热带扰动或潜在热带气旋正在发展、趋向或影响海南；
- `active`：热带低压、热带风暴或已编号台风正在或预计影响海南。

普通雷雨、暴雨和一般大风仍不单独纳入，除非官方明确将其与上述热带天气系统对海南的影响关联。主要风险使用 `hazards` 单独表达，例如大到暴雨、海上大风、雷暴和风暴潮。

优先来源为中央气象台 / 中国气象局、海南省气象部门及海南省政府公开信息。

每日任务不能只检查“台风预警”页面，还应同时检查中央气象台每日天气提示和天气公报；只有这些来源均未提示相关系统时，才允许写入“无影响”。任一官方来源读取失败时，不得把失败当作“无台风”，应保留上一轮结果并标记数据可能过期。
